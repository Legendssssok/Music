...
class MakeButtons:
    ...
    def source_markup(self):
        buttons = [
            ...
            [
                self.ikb(text="Under LegendBot Network { 🇮🇳 }", url="https://t.me/TeamLegendXD"),
            ],
            [
                self.ikb(text="Support 🎙️", url="https://t.me/Spartanupdates"),
                self.ikb(text="Updates 📣", url="https://t.me/Spartanupdates"),
            ],
            [
