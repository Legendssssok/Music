...
class Config(object):
    ...
    LYRICS_API = "nOAsdqvMoEatfCtiPLx6UQZeFDhk08vTIraX2g8sXQFtwtG2l2GXEVDRM7hDX"           # from https://docs.genius.com/
    ...
    TG_VIDEO_SIZE_LIMIT = int(getenv("TG_VIDEO_SIZE_LIMIT", 3073741824))    # size in bytes. 0 for no limit
